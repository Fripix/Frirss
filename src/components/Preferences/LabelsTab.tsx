...
function LabelRow({
  ...
  return (
    ...
    >
      ...
      {/* Row content */}
      <div
        className={`flex items-center gap-1.5 py-1.5 px-2 rounded-md group transition-all prefs-tap-row ${
      ...
      {open && (
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <div
              className="w-7 h-7 prefs-tap-swatch rounded-md border flex-shrink-0 relative overflow-hidden cursor-pointer"
              style={{
