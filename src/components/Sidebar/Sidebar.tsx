...
/**
 * Group labels by prefix (before first "/").
 * If a flat label shares a name with a group prefix, it becomes the parent of that group.
 */
function groupLabels(labels: Tag[], labelOrder: string[] = [], sortAlpha = true): LabelItem[] {
